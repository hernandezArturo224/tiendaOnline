...
public class PDFHeaderFooter  extends PdfPageEventHelper{
    ...
    public void onStartPage(PdfWriter writer, Document document) {
    	...
    	try {
	    	...
	    	String fileLocation = new File("src\\main\\resources\\static\\img").getAbsolutePath() + "\\" + "coche.png";
	    	//imagen
    		//Obtenemos la imagen
    		imagen = Image.getInstance(fileLocation);
	    	...
	    	//texto
    		//Agregamos un texto
    		txtCabecera = new Phrase("ShopTop");
